...
import (
	...
	"resetlife/backend/internal/auth"
	"resetlife/backend/internal/config"
	"resetlife/backend/internal/httpserver"
	"resetlife/backend/internal/reminders"
	"resetlife/backend/internal/settings"
	"resetlife/backend/internal/slimming"
	storagesqlite "resetlife/backend/internal/storage/sqlite"
)
