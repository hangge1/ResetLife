...
- 宝塔网站根目录可配置为 `/www/wwwroot/slimming-assistant/current/public`。
...
DEPLOY_ROOT=/www/wwwroot/slimming-assistant/releases
DEPLOY_CURRENT_LINK=/www/wwwroot/slimming-assistant/current
DEPLOY_DATA_ROOT=/www/wwwroot/slimming-assistant/data
DEPLOY_SQLITE_PATH=/www/wwwroot/slimming-assistant/data/app.sqlite
