...
const fields = [
  { name: "weightKg", label: "体重", unit: "公斤", inputMode: "decimal" },
  { name: "waistCm", label: "腰围", unit: "厘米", inputMode: "decimal" },
  { name: "hipCm", label: "臀围", unit: "厘米", inputMode: "decimal" },
  { name: "bodyFatPercentage", label: "体脂率", unit: "%", inputMode: "decimal" },
] as const;
